...
from config.moea_objectives import (
    OBJECTIVES,
    COMPOSITE_OBJECTIVES
)
from training.train_lightgbm_surrogate import (
    DataConfig,
    ExperimentConfig,
    ModelConfig,
...
class ObjectiveModelOrchestrator:
    ...
    def train_objective(self, objective_name: str) -> Dict:
        ...
        data_config = DataConfig(
            use_phenotypes=self.use_phenotypes and bool(objective.related_phenotypes)
        )
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Train surrogate models for all MOEA objectives"
    )
    parser.add_argument(
        "--objectives",
        nargs="+",
