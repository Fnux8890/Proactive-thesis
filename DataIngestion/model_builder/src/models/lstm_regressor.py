...
class LSTMRegressor(pl.LightningModule):
    ...
    def __init__(self, backbone: nn.Module, learning_rate: float = 1e-3, **kwargs):  # noqa: ARG002
        ...
        """
        super().__init__()
        # Store learning rate for use in configure_optimizers
    ...
    def _common_step(self, batch, batch_idx, stage):  # noqa: ARG002
        x, y = batch
        y_hat = self(x)
