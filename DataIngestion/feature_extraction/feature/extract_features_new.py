...
from ..backend.backend import pd, DataFrame, Series, BACKEND_TYPE, ensure_backend, USE_GPU
...
def load_preprocessed_data(connector: SQLAlchemyPostgresConnector) -> DataFrame | None:
...
def main():
    ...
    try:
        ...
        consolidated_df = load_preprocessed_data(connector)
