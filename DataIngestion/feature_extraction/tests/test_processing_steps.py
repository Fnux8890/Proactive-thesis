...
def test_outlier_handler_do_not_clip():
    ...
    df_input = pd.DataFrame({
        "par_synth_umol": [-999.0, 0.0, 2000.0, 100000.0], # Values outside hypothetical rule [0, 2500]
    ...
    assert_series_equal(df_input["par_synth_umol"], df_output["par_synth_umol"], check_dtype=False,
    ...
    assert_series_equal(expected_other_col, df_output["some_other_col"], check_dtype=False,
